    ...
    <div className="recipemodal-container">
      ...
      <div className="rmc-recipefull">
        <div className="rmcr-left">
          <div className="rmcrl-top">
            <div className="rmcrlt-img">
              <img src={recipe.imageUrl} alt={recipe.title}></img>
            </div>
            <div className="rmcrlt-infos">
              <div className="rmcrlti-container">
                <h1 className="rmcrlti-title">{recipe.title}</h1>
                <div className="rmcrlti-starsreviews">
                ...
                <p className="rmcrlti-description">{desc.slice(0, 350)}</p>
              </div>
              <div className="rmcrlti-likedsaved">
                <div className="rmcrltil-left-container">
                  <div className="rmcrltill-left" onClick={updateLikes}>
                    {isLiked ? (
                      <svg
                        version="1.0"
                        xmlns="http://www.w3.org/2000/svg"
              ...
              -748 10z"
                ...
                <div className="rmcrll-right-container">
                  <div className="rmcrllr-right" onClick={updateSaved}>
                    {isSaved ? (
                      <svg
                        version="1.0"
                        xmlns="http://www.w3.org/2000/svg"
...
-2480 0 -2600 -1 -2683 -19z"
          ...
          <div className="rmcrl-infos">
            <div className="rmcrli-info">
              <h1>Prep. Time:</h1>
          ...
          <div className="rmcrl-ingins">
            <div className="rmcrli-ingredients">
              <h1>Ingredients:</h1>
              <ul className="rmcrlii-ul">
                {recipe.ingredients.map((ingrediente, index) => (
                  <li className="rmcrlii-ingredient" key={index}>
                    {ingrediente}
                  </li>
                ))}
              </ul>
            </div>
            <div className="rmcrli-instructions">
              <h1>Instructions:</h1>
              <ol className="rmcrlii-ol">
                {recipe.instructions.map((istruzione, index) => (
                  <li className="rmcrlii-instruction" key={index}>
                    {istruzione}
                  </li>
                ))}
              </ol>
        ...
        <div className="rmcr-right">
          {/*TODO: mettere reply ad ogni commento*/}
